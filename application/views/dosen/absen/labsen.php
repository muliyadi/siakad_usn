...
<h3 class='panel-title'>KELAS KULIAH
...
<div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div> 
		...
		?>
		    ...
		    <button id="cmdtutup" class="btn btn-primary cmdabsen">Tutup Absen</button>
...
var currentRow = $(this).closest("tr");
   ...
   $.ajax({
                                        url: "<?php echo base_url().'dosen/ajax_save_absen'?>",
                                        type: 'POST',
                                        data: form_data,
       ...
       <script type="text/javascript">
$("#labsen").on('click', '#cmdtutup', function(e) {
...
var currentRow = $(this).closest("tr");
   ...
   $.ajax({
                                        url: "<?php echo base_url().'dosen/ajax_tutup_absen'?>",
                                        type: 'POST',
                                        data: form_data,
                                        success: function(pesan) {
                                           alert(pesan);
                                        window.location.href ='https://siakad.usn.ac.id/list_absen';
