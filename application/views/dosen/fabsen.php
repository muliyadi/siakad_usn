...
<form   action="<?php echo base_url().'dosen/aabsen'?>" method="post" class="form-user form-horizontal">
    ...
    <div class="form-group">
    <label for="pertemuan_ke" class="col-sm-2">PERTEMUAN KE (1,2...16)</label>
    <div class="col-sm-9">
        <input type="text" class="form-control" id="pertemuan_ke" readonly="true"   value="<?php echo $pertemuan_ke?>" name="pertemuan_ke" placeholder="Pertemuan ke: (1,2,3...14)">
    </div>
    ...
    <div class="col-sm-9">
        <input type="number" class="form-control" id="durasi_absen"  value="" name="durasi_absen" placeholder="ISI DURASI WAKTU ABSEN MAHASISWA (Menit)" autofocus="true">
    </div>
    </div>
    <div class="form-group">
