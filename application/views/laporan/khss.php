...
<tr>
    ...
    <td ALIGN="LEFT"  ><?php echo $hkhs->nm_mahasiswa ?></td>

    <td ALIGN="LEFT" width="120">PROGRAM STUDI</td><td width="10"> = </td><td width="200" ><?php echo $hkhs->nm_prodi?></td>

</tr>

<tr>

    <td>NIM / ANGKATAN</td><td width="10"> = </td>

    <td ALIGN="LEFT"><?php echo $hkhs->nim?> / <?php echo $hkhs->angkatan?></td>
...
<tr>
    ...
    <td ALIGN="LEFT"><?php echo $ka_prodi?></td>
	...
	$totangka=0;
		...
		$totangka=$totangka+$row->nilai_a;
            ...
            <tr>
                ...
                <td colspan="7"><b> INDEKS PRESTASI SEMESTER (IPS) =  <?PHP ECHO round($ips,2)?></b>
               </td>
        ...
        <tr >
            ...
            <td align="LEFT"><br>
 <img src=" https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo 'https://siakad.usn.ac.id/mahasiswa/khs/'.$hkhs->no_krs?>" width="70"><br><br>
