            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse navbar-responsive-collapse" style="padding-left:0px;">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"><a tabindex="-1" href="<?php echo base_url() ?>Prodi/lpa"> Perwalian </a>
                        </li>

                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pembayaran <b
                                    class="caret"></b></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown"><a tabindex="-1"
                                        href="<?php echo base_url() ?>prodi/pendaftar_ujian"> Terdaftar </a></li>
                                <li class="dropdown"><a tabindex="-1"
                                        href="<?php echo base_url() ?>prodi/ujian_terjadwal"> Terjadwal </a></li>
                                ...
                                <li class="dropdown"><a tabindex="-1" href="<?php echo base_url() ?>prodi/list_ujian/3">
                                        Diterima </a></li>
                                <li class="dropdown"><a tabindex="-1"
                                        href="<?php echo base_url() ?>prodi/rekap_total_bimbingan_dosen"> Rekap Jumlah
                                        Mahasiswa Bimbingan Dosen </a></li>
                                <li class="dropdown"><a tabindex="-1"
                                        href="<?php echo base_url() ?>prodi/flap_pengujian_dosen_prodi_ta"> Rekap Jumlah
