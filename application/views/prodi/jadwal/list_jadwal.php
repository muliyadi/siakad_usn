...
<?php
	...
	<td>
		...
		<td><?php echo $r['kapasitas']-$r['terisi']?></td>
			<td> <a href="<?php echo $r['group_wa']?>" class="btn btn-success btn-sm">Join</a>
			
		</td>
	<td>
		<a href="<?php echo $r['link_virtual']?>" class="btn btn-info btn-sm">Join</a>	
		</td>
		...
		<td><a class="btn btn-info btn-xs"  href="<?php echo base_url().'prodi/ejk/'.$r['kd_jadwal']?>">Edit</a> 
		    <a class="btn btn-danger btn-xs"  href="<?php echo base_url().'prodi/djk/'.$r['kd_jadwal']?>">Delete</a> 
		     <a href="<?php echo base_url().'prodi/fjadwal_dosen/'.$r['kd_jadwal']?>"class="btn btn-primary btn-xs" >Input Dosen</a>
