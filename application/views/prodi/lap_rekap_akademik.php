...
<html>
    ...
    <body background="">
        <div class="container" >
            ...
            <div>
                <p align="center"><b> PROGRAM STUDI <?php echo $prodi->nm_prodi ?><br>LAPORAN NILAI AKADEMIK MAHASISWA <br>
...
foreach($listta as $ta)
{
    ...
    <td align="center"><?php echo 'IPS '.$ta->kd_tahun_ajaran?></td>
    <?php
}
?>
...
foreach($listta as $ta)
{
    ...
    if($r[$ta->kd_tahun_ajaran]==0)
    {
       $jum=$jum+1; 
        ?>
        <td align="center" style="background-color: red;"><?php echo round($r[$ta->kd_tahun_ajaran],2)?></td>
       
        <?php
    }else
    {
        ?>
         <td align="center" ><?php echo round($r[$ta->kd_tahun_ajaran],2)?></td>
