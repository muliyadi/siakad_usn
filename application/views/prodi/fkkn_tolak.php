...
<h3 class='panel-title'>FORM PENOLAKAN PENDAFTARAN KKN</h3>
</div >
<div class="panel-body">
<div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div> 
<form   action="<?php echo base_url();?>prodi/akkn" method="post" class="form-user form-horizontal" enctype="multipart/form-data">
    ...
    <input type="text" class="form-control" autofocus="true" readonly id="alasan"  value="<?php echo $jum_sks?>" name="jum_sks" placeholder="Jumlah SKS">
        ...
        <div class="form-group">
            <label for="pesan" class="col-sm-2">KETERANGAN</label>
            <div class="col-sm-10">
...
<br>
<h4>Keterangan: "Jumlah SKS yang dihitung hanyalah SKS dengan nilai Lulus"</h4>
</div >
</div >
