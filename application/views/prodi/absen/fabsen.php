...
<form   action="<?php echo base_url('prodi/aabsen')?>" method="post" class="form-user form-horizontal">
   ...
   <div id="materi" class="col-sm-9"> <!-- sebagai indentitas combo box -->
    <input type="text" name="link_kelas" class="form-control" value="<?php echo $link_kelas?>" autofocus="true">
