...
<h3 class='panel-title'>Laporan Pendaftaran Judul Penelitian</h3>
</div >
<div class="panel-body">
    <form   action="<?php echo base_url();?>prodi/laporan_judul" method="post" class="form-user form-horizontal" id="aktifta">
