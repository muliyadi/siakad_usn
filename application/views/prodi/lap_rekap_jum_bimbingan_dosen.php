...
<html>
    ...
    <body background="">
        <div class="container" >
            ...
            <div>
                <p align="center"><b>LAPORAN JUMLAH MAHASISWA BIMBINGAN DOSEN <br>
                TAHUN AKADEMIK <?php echo $this->session->userdata('kd_tahun_ajaran');?><br>
...
<?php
	...
	<tr >
		...
		<td align="center"><?php echo $r->pembimbing?></td>
