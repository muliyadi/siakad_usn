...
<h3 class='panel-title'>List Matakuliah Yang Telah Ditawar Mahasiswa</h3>
</div >
  ...
  <td align=center><?php echo $row->semester_ke?></td>
              ...
              <td align="center"><?php echo $row->nilai_a ?></td>
               ...
               <td align="center"><?php echo  $row->sks*$row->nilai_a?></td>
                ...
                <td>
                 <a class="btn btn-info btn-xs" onclick="return confirm('Anda yakin?');"  href="<?php echo base_url().'prodi/aktif_matkul_krs/'.$row->no_krs.'/'.$row->kd_mtk.'/'.$mahasiswa->nim?>">Aktif</a> 
                 <a class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin?');"  href="<?php echo base_url().'prodi/hapus_matkul_krs/'.$row->no_krs.'/'.$row->kd_mtk.'/'.$mahasiswa->nim?>">Non Aktif</a> 
</td>
                </tr>
