...
<br>
<form   action="<?php echo base_url();?>prodi/amatakuliah" method="post" class="form-user form-horizontal" id="fmatakuliah">
...
<option></option>
    ...
    <div id="combox" class="col-sm-10"> <!-- sebagai indentitas combo box -->
	<select name="kd_jenis_mtk" id="kd_jenis_mtk" class="form-control">
<?php
...
?>
	...
	<div class="form-group">
    <label for="kd_mtk" class="col-sm-2">KODE MATA KULIAH</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="kd_mtk"  value="<?php echo $kd_mtk?>" name="kd_mtk" placeholder="KODE MATAKULIAH">
    </div>
    </div>
        <div class="form-group">
    <label for="nm_mtk" class="col-sm-2">NAMA MATA KULIAH</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="nm_mtk" value="<?php echo $nm_mtk?>" name="nm_mtk" placeholder="NAMA MATAKULIAH">
    </div>
    </div>
    <div class="form-group">
    <label for="sks" class="col-md-2">SKS TEORI</label>
    <div class="col-md-10">
        <input type="text" class="form-control" id="sks_teori" name="sks_teori" value="<?php echo $sks_teori?>" placeholder="SKS TEORI">
    </div>
    </div>
	<div class="form-group">
    <label for="sks_praktikum_lab" class="col-md-2" >SKS PRAKTIKUM LAB</label>
    <div class="col-md-10">
        <input type="text" class="form-control" id="sks_praktikum_lab" name="sks_praktikum_lab" value="<?php echo $sks_praktikum_lab?>"   placeholder="JUMLAH SKS PRAKTIKUM LAB">
    </div>
    </div>
	<div class="form-group">
    <label for="sks_praktikum_lapangan" class="col-md-2" >SKS PRAKTIKUM LAPANGAN</label>
    <div class="col-md-10">
        <input type="text" class="form-control" id="sks_praktikum_lapangan" name="sks_praktikum_lapangan" value="<?php echo $sks_praktikum_lapangan?>"   placeholder="JUMLAH SKS PRAKTIKUM LAB">
    </div>
    </div>
    ...
    <div class="col-md-10">
        <input type="text" class="form-control" id="semester_ke" name="semester_ke" value="<?php echo $semester_ke?>"   placeholder="SEMESTER KE, ISI DENGAN ANGKA 1,2,3,4,5,6,7,8">
    </div>
    </div>
