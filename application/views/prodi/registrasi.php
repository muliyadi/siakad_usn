...
<form action="<?php echo base_url();?>Prodi/aregistrasi" method="post" class="form-user form-horizontal">
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" style="display: none;"/>
    <input type="hidden"  id="aksi" class="form-control" name="aksi" autofocus="true" value="<?php echo $aksi; ?>" />
            <div class="form-group">
			<label for="no_reg_bank" class="col-md-2">NO. BUKTI TRANSAKSI</label>
			...
			<div class="form-group">
			<label for="tgl_reg_bank" class="col-md-2">TGL REG TRANSAKSI</label>
			<div class="col-md-10">
