        ...
        <div class="container" >
            ...
            <table class="word-table" style="margin-bottom: 10px">
                ...
                <tr height="40">
                    ...
                    <th width="60%" style="text-align: left;" >Tingkat pemahaman mahasiswa terhadap latar belakang permasalahan</th>
                ...
                <tr height="40">
                    ...
                    <th width="60%" style="text-align: left;" >Tingkat pemahaman dan skill mahasiswa terhadap landasan teori teori yang mendukung mahasiswa melaksanakan penelitian</th>
                ...
                <tr height="40">
                    ...
                    <th width="60%" style="text-align: left;" >Tingkat pemahaman dan skill mahasiswa terhadap metodologi/metode penelitian yang akan digunakan</th>
                    <th  width="" style="text-align: center;">3</th>
                    <th width="20%"style="text-align: center;" ></th>
                    <th width="20%"style="text-align: center;" ></th>
                </tr>
                ...
                <tr height="40">
                    <th style="text-align: center;" width="50" colspan='2'>Total </th>
                    <th  width="" style="text-align: center;">10</th>
                    <th width="20%"style="text-align: center;" ></th>
                    <th width="20%"style="text-align: center;" ></th>
                </tr>
                <tr height="40">
                    <th style="text-align: center;" width="50" colspan='2'>Nilai Akhir</th>
                    <th  width="" style="text-align: center;" colspan=3></th>
            ...
            <table class="wordx-table" align="center">
                ...
                <tr height='30'>
                     <td>Lulus</td><td align="center">:</td><td>Nilai Akhir >=2.75 </td>
                     
                </tr>
                <tr height='30'>
                     <td>Tidak Lulus</td><td align="center">:</td><td>Nilai Akhir < 2.75 </td>
