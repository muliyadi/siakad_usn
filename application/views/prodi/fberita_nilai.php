...
<h3 class='panel-title'>Cetak Nilai Ujian</h3>
</div >
<div class="panel-body">
    <form   action="<?php echo base_url();?>prodi/berita_nilai" method="post" class="form-user form-horizontal" id="lap_registrasi">
...
<button type="submit">Cetak Nilai Ujian</button>
</form>
</div>
</div>