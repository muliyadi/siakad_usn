...
<div class="col-md-9">
	 <select name="jenis_ujian" id="jenis_ujian" autofocus="true" class="form-control"  >
...
<?php
    ...
    <option value="<?php echo $ujian->urutan; ?>" ><?php echo $ujian->jenis_ujian?></option>
...
<label for="judul" class="col-md-2">NO DAFTAR JUDUL</label>
			<div class="col-md-9">
				<input type="text" class="form-control"   name="no_daftar_judul" id="no_daftar" placeholder="NO DAFTAR" autofocus="true" value="<?php echo $no_daftar; ?>" />
			</div>
			<div class="col-md-1">
...
<div class="form-group">
    ...
    <div class="col-md-2">
        <input type="text" readonly="true"  class="form-control required" value="<?php echo $nim ?>"  id="nim" name="nim" placeholder="NIM">
    </div>
    <div class="col-md-5">
        <input type="text" readonly="true" class="form-control" id="nm_mahasiswa" placeholder="NAMA MAHASISWA">
    </div>
     <div class="col-md-2">
        <input type="text" readonly="true" class="form-control" name='angkatan' id="angkatan" placeholder="ANGKATAN">
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-2">
        <input type="text" readonly="true" data-toggle="modal" data-target="#myModaldosen" class="form-control required" value="<?php echo $kd_dosen_pembimbing1 ?>"  id="kd_dosen_pembimbing1" name="kd_dosen_pembimbing1" placeholder="KODE DOSEN">
    </div>
    <div class="col-md-5">
        <input type="text" readonly="true" class="form-control" id="nm_dosen_pembimbing1" placeholder="NAMA DOSEN">
    </div>
     <div class="col-md-2">
...
<div class="form-group">
    ...
    <div class="col-md-2">
        <input type="text" readonly="true" data-toggle="modal" data-target="#myModaldosen" class="form-control required" value="<?php echo $kd_dosen_pembimbing2 ?>"  id="kd_dosen_pembimbing2" name="kd_dosen_pembimbing2" placeholder="KODE DOSEN">
    </div>
    <div class="col-md-5">
        <input type="text" readonly="true" class="form-control" id="nm_dosen_pembimbing2" placeholder="NAMA DOSEN">
    </div>
     <div class="col-md-2">
...
<div class="form-group">
    ...
    <div class="col-md-2">
        <input type="text" readonly="true" data-toggle="modal" data-target="#myModaldosen" class="form-control required" value="<?php echo $kd_dosen1 ?>"  id="kd_dosen" name="kd_dosen1" placeholder="KODE DOSEN">
    </div>
    <div class="col-md-5">
        <input type="text" readonly="true" class="form-control" id="nm_dosen" placeholder="NAMA DOSEN">
    </div>
     <div class="col-md-2">
        <input type="text" readonly="true" class="form-control" name='jafung' id="jafung" placeholder="Jafung">
    </div>
    <div class="col-md-1">
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" readonly="true" class="form-control" id="nm_dosen2" placeholder="NAMA DOSEN">
    </div>
        <div class="col-md-2">
        <input type="text" readonly="true" class="form-control" name='jafung2' id="jafung2" placeholder="Jafung">
    </div>
    <div class="col-md-1">
...
<div class="form-group">
    ...
    <div class="col-md-2">
        <input type="text" readonly="true" data-toggle="modal" data-target="#myModaldosen3" class="form-control " value="<?php echo $kd_dosen2 ?>"  id="kd_dosen3" name="kd_dosen3" placeholder="KODE DOSEN">
    </div>
    <div class="col-md-5">
        <input type="text" readonly="true" class="form-control" id="nm_dosen3" placeholder="NAMA DOSEN">
    </div>
        <div class="col-md-2">
        <input type="text" readonly="true" class="form-control" name='jafung3' id="jafung3" placeholder="Jafung">
    </div>
    <div class="col-md-1">
...
<div class="col-md-9">
<input type="text" class="form-control"   name="tgl_ujian" id="tgl_ujian" placeholder="TGL DAFTAR"  value="<?php echo $tgl_daftar; ?>" />
</div>
...
<label for="tgl_ujian" class="col-md-2">JAM UJIAN</label>
			<div class="col-md-9">
				<input type="text" class="form-control"   name="jam_ujian" id="jam_ujian" placeholder="TGL DAFTAR"  value="<?php echo $jam_ujian; ?>" />
			</div>
...
<label for="tgl_ujian" class="col-md-2">RUANG UJIAN</label>
			<div class="col-md-9">
				<input type="text" class="form-control"   name="ruang_ujian" id="ruang_ujian" placeholder="TGL DAFTAR"  value="<?php echo $ruang_ujian; ?>" />
			</div>
