    ...
    <div class="panel-body">
        ...
        <form   id="fdosen"action="<?php echo base_url(); ?>bak/adosen" method="post" class="form-user form-horizontal">
			...
			<div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" autofocus="true" class="form-control " id="kd_dosen"  value="<?php echo $kd_dosen ?>" name="kd_dosen" placeholder="Isi dengan Nomor Induk Kepegawaian USN yang baru">
                </div>
            </div>
            <div class="form-group">
