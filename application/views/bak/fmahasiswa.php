...
<div class="panel panel-primary">
   ...
   <form   action="<?php echo base_url();?>bak/amahasiswa" method="post" class="form-user form-horizontal" id="fmahasiswa" onsubmit="return validasi_input(this)">
            ...
            <div class="well col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="required form-control"  required="true" id="nim" value="<?php echo $nim ?>" name="nim" placeholder="NIM">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nim" class=" col-md-2" >Nomor Induk Kependudukan  (*)</label>
                    <div class="col-md-10">
                        <input type="text" class="required form-control"  id="nik" value="<?php echo $NIK ?>" name="nik" placeholder="NIK">

                    </div>

                </div>
                <div class="form-group">
                    <label for="nim" class="col-md-2" >NAMA MAHASISWA (*) <BR> Sesuai Nama di Ijazah</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nm_mahasiswa" id="nm_mahasiswa" value="<?php echo $nm_mahasiswa ?>" placeholder="NAMA MAHASISWA">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nim" class="col-md-2" >TEMPAT LAHIR  (*) <br>
                    Sesuai Tempat Lahir di Ijazah</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control required" id="tempat_lahir" name="tempat_lahir" value="<?php echo $tempat_lahir ?>" placeholder="TEMPAT LAHIR">
                    </div>

                </div>

                <div class="form-group">
                    <label for="nim" class="col-md-2" >TANGGAL LAHIR  (*) <br>
               ...
               <div class="form-group">
			<label for="agama" class="col-md-2" ><font color="red">AGAMA  (*)</font></label>
			<div class="col-md-10">
...
<div class="form-group">
			<label for="agama" class="col-md-2" >KEWARGANEGARAAN  (*)</label>
			<div class="col-md-10">
...
<div class="form-group">
<label for="provinsi" class="col-md-2" >Kecamatan </label>
<div class="col-md-2">
<input type="text" class="form-control" id="id_wilayah_kec" readonly name="id_wilayah_kec" value="<?php echo $id_wilayah_kec ?>" placeholder="ID Kecamatan">

    </div>
    <div class="col-md-3">
<input type="text" class="form-control" id="nm_wilayah_kec" readonly name="nm_wilayah_kec" value="<?php echo $nm_wilayah_kec ?>" placeholder="Nama Kecamatan">
...
<div class="col-sm-10">
<input type="text" class="form-control" id="kelurahan" name="kelurahan" value="<?php echo $kelurahan ?>" placeholder="Kelurahan">
</div>
</div>
<div class="form-group">
<label for="nim" class="col-md-2" >Dusun  (+)</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="dusun" name="dusun" value="<?php echo $dusun ?>" placeholder="Dusun">
</div>
</div>
<div class="form-group">
<label for="nim" class="col-md-2" >RW / RT  (+)</label>
<div class="col-sm-5">
<input type="text" class="form-control" id="rw" name="rw" value="<?php echo $rw ?>" placeholder="RW">
</div>
<div class="col-sm-5">
<input type="text" class="form-control" id="rt" name="rt" value="<?php echo $rt ?>" placeholder="RT">
</div>
</div>
<div class="form-group">
<label for="nim" class="col-md-2" >Jalan (+)</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="jalan" name="jalan" value="<?php echo $jalan ?>" placeholder="Alamat">
</div>
</div>
<div class="form-group">
<label for="nim" class="col-md-2" >JENIS TINGGAL (*)</label>
<div class="col-sm-10">
...
{
    $selected = '';
    if($kd_jenis_tinggal==$jt->kd_jenis_tinggal)
    {
        $selected = 'selected="selected"';
    }
    ?>
...
?>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="telp_rumah" name="telp_rumah" value="<?php echo $telp_rumah ?>" placeholder="telp_rumah">
                    </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                    <label for="nim" class="col-md-2" >EMAIL (+)</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="email" name="email" value="<?php echo $email ?>" placeholder="email">
                    </div>
                </div>
                 <div class="form-group">
                    <label for="pend_ayah" class="col-md-2" >Jenis Pembiayaan</label>
                    <div class="col-sm-10">
...
<option value=''>Pilih</option>
			...
			{
    $selected = '';
    if($jns_pembiayaan ==$jns_pembiayaan->id_jns_pembiayaan)
    {
        $selected = 'selected="selected"';
    }
    ?>
...
?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="terima_kps" name="terima_kps" value="<?php echo $terima_kps ?>" placeholder="Terima KPS [0 = Tidak, 1 = Ya]">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nim" class="col-md-2" >No KPS (+)</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="no_kps" name="no_kps" value="<?php echo $no_kps ?>" placeholder="Kosongkan saja jika tidak terima">
                    </div>
                </div>
                <div class="form-group">
...
<option valus="pilih">Pilih</option>
			...
			{
    $selected = '';
    if($kd_prodi==$prodi->kd_prodi)
    {
        $selected = 'selected="selected"';
    }
    ?>

    <option value="<?php echo $prodi->kd_prodi; ?>" <?php echo $selected; ?>><?php echo $prodi->nm_prodi?></option>
...
?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text"  class="form-control"  id="semester" name="semester" value="<?php echo $semester ?>" placeholder="Semester">
                    </div>
                </div>
...
<option valus="pilih">Pilih</option>
			...
			{
    $selected = '';
    if($jalur_masuk==$jm->id_jalur_masuk)
    {
        $selected = 'selected="selected"';
    }
    ?>
...
?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" id="status"  name="status" value="<?php echo $status ?>" placeholder="STATUS">
                    </div>
                </div>
            ...
            <div class="well"> 
                ...
                <div class="form-group">
    <label for="kapasitas" class="col-md-2" >NPSN</label>
    <div class="col-md-3">
        <input type="text" class="form-control" id="npsnx"  value="<?php echo $npsn?>" name="npsnx" placeholder="NPSN:Nomor Pokok Sekolah Nasional">
    </div>
    ...
    <a href='#myModal' class='btn btn-info btn-small'  data-toggle='modal' >Cari</a>
                ...
                <div class="form-group">
                    <label for="nim" class="col-md-2" >NO INDUK SISWA NASIONAL (+)</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control"  name="nisn" id="nisn" value="<?php echo $nisn ?>" placeholder="NISN">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nim" class="col-md-2" >JURUSAN (IPA, IPS, BAHASA, LAIN)</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="jurusan_sma" name="jurusan_sma" value="<?php echo $jurusan_sma ?>" placeholder="JURUSAN">
                    </div>
                </div>
                 <div class="form-group">
                    <label for="thn_tamat" class="col-md-2" >TAHUN LULUS </label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control"  name="thn_tamat_sma" id="thn_tamat_sma" value="<?php echo $thn_tamat_sma ?>" placeholder="TAHUN LULUS">
                    </div>
                </div>
    ...
    <div class="well"> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control"  name="no_kk" id="no_kk" value="<?php echo $no_kk ?>" placeholder="NO KK">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nim" class="col-md-2" >NAMA AYAH</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nm_ayah" name="nm_ayah" value="<?php echo $nm_ayah ?>" placeholder="NAMA AYAH">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nim" class="col-md-2" >TGL LAHIR AYAH</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tgl_lahir_ayah" name="tgl_lahir_ayah" value="<?php echo $tgl_lahir_ayah ?>" placeholder="yyyy-mm-dd">
                    </div>
                </div>
                <div class="form-group">
                    <label for="pend_ayah" class="col-md-2" >PENDIDIKAN AYAH</label>
                    <div class="col-sm-10">
...
<option value=''>Pilih</option>
			...
			{
    $selected = '';
    if($pend_ayah==$row->kd_jenjang_pendidikan)
    {
        $selected = 'selected="selected"';
    }
    ?>
...
?>
			...
			<div class="form-group">
			<label for="penghasilan_ayah" class="col-md-2" >PENGHASILAN AYAH</label>
			<div class="col-md-10">
			...
			{
    $selected = '';
    if($penghasilan_ayah==$row->kd_gol_penghasilan)
    {
        $selected = 'selected="selected"';
    }
    ?>
...
?>
                ...
                <div class="form-group">
                    <label for="nm_ibu" class="col-md-2" >NAMA IBU</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="nm_ibu" name="nm_ibu" value="<?php echo $nm_ibu ?>" placeholder="NAMA IBU">
                    </div>
                </div>
                <div class="form-group">
                    <label for="tgl_lahir_ibu" class="col-md-2" >TGL LAHIR IBU</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="tgl_lahir_ibu" name="tgl_lahir_ibu" value="<?php echo $tgl_lahir_ibu ?>" placeholder="yyyy-mm-dd">
                    </div>
                </div>
                <div class="form-group">
                    <label for="pend_ibu" class="col-md-2" >PENDIDIKAN IBU</label>
                    <div class="col-md-10">
...
<option value=''>Pilih</option>
			...
			{
    $selected = '';
    if($pend_ibu==$row->kd_jenjang_pendidikan)
    {
        $selected = 'selected="selected"';
    }
    ?>
...
?>
            ...
            <div class="form-group">
			<label for="penghasilan_ibu" class="col-md-2" >PENGHASILAN IBU</label>
			<div class="col-md-10">
			...
			{
    $selected = '';
    if($penghasilan_ibu==$rows->kd_gol_penghasilan)
    {
        $selected = 'selected="selected"';
    }
    ?>
...
<script type="text/javascript">
     $("#tblkecmatan").on('click', '.pilihkecamatan', function(e) {
            ...
            document.getElementById("nm_wilayah_kec").value = currentRow.find(".tnm_kecamatan").html();
