<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <form   id="fdosen"action="<?php echo base_url(); ?>bak/adosen" method="post" class="form-user form-horizontal">
...
<option></option>
            ...
            <div class="form-group">
                <label for="kd_dosen" class="col-sm-2">Nomor Induk Kepegawaian</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control required" id="kd_dosen"  value="<?php echo $kd_dosen ?>" name="kd_dosen" placeholder="LIHAT SK DOSEN">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="kd_dosen" class="col-sm-2">Pendidikan S1</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control required" id="s1"  value="<?php echo $s1 ?>" name="s1" placeholder="S1 Informatika UGM">
                </div>
            </div>
            <div class="form-group">
                <label for="kd_dosen" class="col-sm-2">Pendidikan S2</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control required" id="s2"  value="<?php echo $s2 ?>" name="s2" placeholder="S2">
                </div>
            </div>
            <div class="form-group">
                <label for="kd_dosen" class="col-sm-2">Pendidikan S3</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control required" id="s3"  value="<?php echo $s3 ?>" name="s3" placeholder="S3">
                </div>
            </div>
            <div class="form-group">
