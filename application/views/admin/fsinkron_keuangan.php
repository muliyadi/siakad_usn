<div class="panel panel-primary">
    ...
    <div class="panel-body">
       <div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div> 
        <form   action="<?php echo base_url(); ?>admin/sinkron_pembayaran" method="post" class="form-user form-horizontal" id="fuser">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" style="display: none;"/>
            <div class="form-group">
                <label for="userid" class="col-sm-2">TAHUN AKADEMIK</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control required" id="ta"  name="ta"   placeholder="20191">
                </div>
            </div>
