...
<tr>
    ...
    <td width="120">NAMA MAHASISWA</td><td width="15"> = </td>

    <td ALIGN="LEFT" width="300" ><?php echo $hkhs->nm_mahasiswa ?></td>

    <td ALIGN="LEFT" width="157">&nbsp;</td>
    <td ALIGN="LEFT" width="157">PROGRAM STUDI</td>
    <td width="15"> = </td>
    <td width="350" ><?php echo $hkhs->nm_prodi?></td>
</tr>
...
<tr>
    ...
    <td ALIGN="LEFT"><?php echo $hkhs->nim?></td>

    <td ALIGN="LEFT">&nbsp;</td>
    <td ALIGN="LEFT">TAHUN AKADEMIK</td><td width="15"> = </td>
    <td  width="350"><?php echo $hkhs->tahun_ajaran?>-<?php echo $hkhs->semester?></td>
</tr>
...
<tr>
    ...
    <td ALIGN="LEFT">&nbsp;</td>
    <td ALIGN="LEFT">DOSEN PA</td>
    <td width="15"> = </td><td  width="350"><?php if($pa){$pa->nm_dosen;} ?></td>
</tr>
</table>
	...
	$totangka=0;
        ...
        <tr height="70">
            ...
            <td ></td>
            <td><img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo base_url('mahasiswa/khs').'/'.$hkhs->no_krs?>" width="80"></td>
