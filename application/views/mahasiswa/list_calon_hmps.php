...
<h3 class='panel-title'>Pemilihan Ketua HMPS SI </h3>
</div >
...
<script src="<?php echo base_url('assets/plugins/datatables/dataTables.bootstrap.min.js') ?>"></script>
 ...
 $("#test").on('click', '.hadir', function(e) {
   ...
   $.ajax({
                                        url: "<?php echo base_url().'mahasiswa/vote_hmps'?>",
                                        type: 'POST',
                                        data: form_data,
                                        success: function(pesan) {
                                           if(pesan==1)
                                           {
                                               alert("Tersimpan....Terimakasih sudah memilih....!!!, Yang Anda pilih Calon Ketua HMPS No."+no_calon)
                                           }else{
                                            alert("Mohon maaf, Anda sudah memilih dan tidak  bisa merubah pilihan Anda...!!!")
