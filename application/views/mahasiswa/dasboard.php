...
<div class="panel panel-primary">
    <div class="panel-body">
JUMLAH MAHASISWA REGISTRASI SETIAP PRODI TAHUN AJARAN BERJALAN<hr align="center" size="1" color="#cccccc">
...
$('#TableSiswa2').convertToFusionCharts({
        swfPath: "<?php echo base_url() ?>assets/chart/Charts/",
        type: "MSColumn3D",
        data: "#TableSiswa2",
        dataFormat: "HTMLTable"
    });
$('#TableSiswa3').convertToFusionCharts({
        swfPath: "<?php echo base_url() ?>assets/chart/Charts/",
        type: "MSColumn3D",
        data: "#TableSiswa3",
        dataFormat: "HTMLTable"
