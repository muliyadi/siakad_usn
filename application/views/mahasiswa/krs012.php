    ...
    <body background=""  onload="window.print();">
        <div class="container" >
            ...
            <table class="word-table" style="margin-bottom: 10px">
                ...
                foreach ($krsd as $row) {
                    ...
                    <tr>
                        ...
                        <td align="center"><?php echo substr($row->kd_mtk, 5, $lebar) ?></td>
            ...
            <table class="wordx-table">
                ...
                <tr align="center">
                    <td height="0" width="33%">Ketua Program Studi</td>
                    <td width="33%"  ></td>
                ...
                <tr align="center">
                    <td height="0"><?php echo $krsh->ka_prodi; ?></td>
                    <td align=""> </td>
                    <td><?php echo $krsh->nm_mahasiswa?></td>
