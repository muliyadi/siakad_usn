...
<h3 class='panel-title'>FORM LAPORAN AKM PRODI PER TAHUN AKADEMIK</h3>
</div >
<div class="panel-body">
<form   action="<?php echo base_url();?>pddikti/akmprodita" method="post" class="form-user form-horizontal">
...
<div class="col-md-9">
<input type="text" placeholder="ex: 2017" class="form-control" name="angkatan">
</div>
</div>
<div class="form-group">
