...
<h3 class='panel-title'>FORM LAPORAN KELAS PRODI PER TAHUN AKADEMIK</h3>
</div >
<div class="panel-body">
<form   action="<?php echo base_url();?>pddikti/kelas_prodi_ta" method="post" class="form-user form-horizontal">
